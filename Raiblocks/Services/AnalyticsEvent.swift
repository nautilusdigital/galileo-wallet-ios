...
enum AnalyticsEvent: String {
    ...
    case errorDecodingCMCNanoPriceData = "Error decoding CoinMarketCap Galileo price data"
    case errorGettingCMCBTCPriceData = "Error getting CoinMarketCap BTC price data"
    case errorGettingCMCNanoPriceData = "Error getting CoinMarketCap Galileo price data"
    ...
    case nanoAddressCopied = "Galileo Address Copied"
    ...
    case sendBegan = "Send Galileo Began"
    case sendFinished = "Send Galileo Finished"
    case sendMaxAmountUsed = "Send: Max Amount Used"
    case sendWorkUnwrapFailed = "Send VC Send Galileo Work Unwrap Failed"
    ...
    case errorFormattingNanoStringToDouble = "Error formatting Galileo Price Pair String to Double"
    case errorInNanoDecodeFunction = "Error in NanoPricePair.decode function"
    case unableToGetNanoPrice = "Galileo Price Pair Error: unable to get price"
