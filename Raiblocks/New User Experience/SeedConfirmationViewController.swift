...
class SeedConfirmationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        titleLabel.text = "Your Galileo Wallet Seed"
    ...
    @objc func continueButtonWasPressed() {
        ...
        let ac = UIAlertController(title: "Welcome to Galileo Wallet!", message: "Please confirm you have properly stored your Wallet Seed somewhere safe.", preferredStyle: .actionSheet)
